    ...
    <div className="flex flex-col min-h-screen items-center justify-center relative">
      <div className="flex w-full md:w-1/2 py-16">
        ...
        <main className="flex-1 p-0 md:p-0 w-full md:pl-0 border-l border-neutral-700 ">
          <h1 className="text-3xl md:text-4xl font-bold mb-2 px-4 pt-2">Resources</h1>
          ...
          <p className="text-2xl px-4 text-emerald-400 mt-4">Deeper Into Networks</p>
					<ul className="list-disc text-2xl ml-4 px-4 py-2">
						<li>Beej's <a href="https://beej.dev/bgnet0/" className="text-emerald-400 underline underline-offset-4">Guide</a> to Networking Concepts</li>
						<li>Beej's <a href="https://beej.dev/bgnet/" className="text-emerald-400 underline underline-offset-4">Guide</a> to Network Programming</li>
					</ul>
